...
<body>
    ...
    <div class="message">
        <p>Prezado(a) {{ $quotation->customer->name }},</p>

        <p>Esperamos que esteja tudo bem. Segue em anexo a cotação nº {{ $quotation->quotation_number }},
            conforme sua solicitação.</p>
        ...
        <div class="quotation-info">
            ...
            <p><strong>Validade:</strong>
                {{ $quotation->expiry_date ? date('d/m/Y', strtotime($quotation->expiry_date)) : 'N/A' }}</p>
            <p><strong>Valor Total:</strong> {{ number_format($quotation->total, 2, ',', '.') }}
