...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Novo', href: '/admin/employees/create' },
];
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            ...
                                            <FormField control={form.control} name="academic_level" render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="Ex: Licenciatura" {...field} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )} />
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <FormField control={form.control} name="notes" render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Textarea placeholder="Notas adicionais sobre o funcionário..." {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )} />
                        ...
                        <div className="flex justify-end gap-2">
                            ...
                            <Button type="submit">Guardar Funcionário</Button>
                        </div>
                    </form>
                </Form>
            </div>
