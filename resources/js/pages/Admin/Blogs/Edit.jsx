...
export default function Edit({ blog, categories }) {
    ...
    return (
        <AdminLayout>
            <Head title={`Editar Post - ${blog.title}`} />
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center">
                            ...
                            />
                            <InputLabel htmlFor="status" value="Publicado" className="ml-2" />
                            <InputError message={errors.status} className="mt-2" />
                        </div>

                        {blog.published_at && (
                            <div className="text-sm text-gray-500">
                                Publicado em: {formatDate(blog.published_at)}
                            </div>
                        )}
                        ...
                        <div className="flex justify-end">
                            ...
                            >
                                {processing ? 'A processar...' : 'Atualizar'}
                            </button>
                        </div>
                    </form>
                </div>
