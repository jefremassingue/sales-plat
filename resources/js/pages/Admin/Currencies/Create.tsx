...
export default function Create() {
  ...
  const onSubmit = (values: FormValues) => {
    ...
    router.post('/admin/currencies', data, {
      onSuccess: () => {
        setIsSubmitting(false);
        toast({
          title: "Moeda criada",
          description: "A moeda foi criada com sucesso.",
          variant: "success",
        });
      },
      onError: () => {
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="container px-4 py-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold">Nova Moeda</h1>
        </div>
            ...
            <div className="grid gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Configure os dados básicos da moeda
                  </CardDescription>
                </CardHeader>
