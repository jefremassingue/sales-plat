...
import { BasicInfoTab, PermissionsTab, Permission, Role } from './_components';
...
export default function Edit({ role, permissions, rolePermissions }: Props) {
  ...
  // Inicializar o formulário com os dados da função
  ...
  const onSubmit = (values: FormValues) => {
    ...
    try {
      ...
      router.put(`/admin/roles/${role.id}`, values, {
        onSuccess: () => {
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="container px-4 py-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold">Editar Função: {role.name}</h1>
        </div>
