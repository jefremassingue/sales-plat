...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
    return (
        <div className="group relative bg-white rounded-lg border border-zinc-100 transition-shadow duration-300">
            <Link href={`/products/${product.slug}`} className="flex flex-col justify-between h-full">
                ...
                <div className="flex flex-col justify-between p-4 flex-1 gap-4 h-full">
                    ...
                    <div className="flex justify-between gap-2">
                        <button className="text-orange-600 hover:bg-orange-600 hover:text-white cursor-pointer border border-orange-500 bg-white font-medium py-2.5 px-4 rounded-lg text-sm transition-colors duration-300 flex items-center justify-center gap-2">
                            <ShoppingCart size={16} />
                        </button>
                        <button className="w-full bg-orange-600 hover:bg-orange-700 text-white cursor-pointer font-medium py-2.5 px-4 rounded-lg text-sm transition-colors duration-300 flex items-center justify-center gap-2">
