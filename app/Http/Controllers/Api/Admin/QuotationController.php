...
class QuotationController extends Controller
{
    ...
    public function create()
    {
        try {
            ...
            return response()->json(['error' => 'Ocorreu um erro ao carregar o formulário: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            try {
                ...
                return response()->json(['error' => 'Ocorreu um erro ao criar a cotação: ' . $e->getMessage()], 500);
            }
        } catch (\Exception $e) {
            ...
            return response()->json(['error' => 'Ocorreu um erro ao validar os dados: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function edit(Quotation $quotation)
    {
        if (!$quotation->isEditable()) {
            return response()->json(['error' => 'Esta cotação não pode ser editada devido ao seu status atual.'], 403);
        }
    ...
    public function update(Request $request, Quotation $quotation)
    {
        try {
            ...
            try {
                ...
                return response()->json(['error' => 'Ocorreu um erro ao atualizar a cotação: ' . $e->getMessage()], 500);
            }
        } catch (\Exception $e) {
            Log::error('Erro na validação da cotação: ' . $e->getMessage(), [
                'trace' => $e->getTraceAsString()
    ...
    public function destroy(Quotation $quotation)
    {
        try {
            ...
            return response()->json(['error' => 'Ocorreu um erro ao excluir a cotação: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function updateStatus(Request $request, Quotation $quotation)
    {
        try {
            ...
            return response()->json(['message' => 'Status da cotação atualizado com sucesso!']);
        } catch (\Exception $e) {
            DB::rollBack();
            ...
            return response()->json(['error' => 'Ocorreu um erro ao atualizar o status da cotação: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function sendEmail(Quotation $quotation)
    {
        try {
            ...
            if (!$quotation->customer || !$quotation->customer->email) {
                return response()->json(['error' => 'Cliente sem endereço de email válido para envio.'], 400);
            }
            ...
            return response()->json(['message' => 'Cotação enviada com sucesso para ' . $quotation->customer->email]);
        } catch (\Exception $e) {
            DB::rollBack();
            ...
            return response()->json(['error' => 'Ocorreu um erro ao enviar o email: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function duplicate(Quotation $quotation)
    {
        try {
            ...
            return response()->json([
                ...
                'quotation' => $newQuotation->load(['customer', 'items'])
            ]);
        } catch (\Exception $e) {
            DB::rollBack();
            ...
            return response()->json(['error' => 'Ocorreu um erro ao duplicar a cotação: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function convertToSale(Quotation $quotation)
    {
        try {
            ...
            if (!in_array($quotation->status, ['sent', 'draft', 'approved'])) {
                return response()->json(['error' => 'Apenas cotações enviadas ou aprovadas podem ser convertidas em venda.'], 400);
            }

            if ($quotation->converted_to_sale_id) {
                return response()->json(['error' => 'Esta cotação já foi convertida na venda ID: ' . $quotation->converted_to_sale_id], 400);
            }
            ...
            return response()->json([
                'message' => 'Cotação convertida em venda com sucesso!',
            ...
            return response()->json(['error' => 'Ocorreu um erro ao converter a cotação: ' . $e->getMessage()], 500);
        }
    }
