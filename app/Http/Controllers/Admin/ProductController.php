...
class ProductController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:admin-product.index', only: ['index']),
            new Middleware('permission:admin-product.create', only: ['create', 'store']),
    ...
    public function update(Request $request, Product $product)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'existing_image_ids.*' => 'nullable|exists:images,id',
                'delete_image_ids' => 'nullable|array',
                'delete_image_ids.*' => 'nullable|exists:images,id',
            ], [
                'name.required' => 'O nome do produto é obrigatório.',
                'slug.regex' => 'O slug deve conter apenas letras minúsculas, números e hífens.',
                'slug.unique' => 'Este slug já está a ser utilizado por outro produto.',
